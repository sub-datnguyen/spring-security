...
import vn.elca.codebase.entity.AbstractCodeBaseEntity;
import vn.elca.codebase.util.JpaUtil;
...
public abstract class AbstractCodeBaseRepositoryImpl<T extends AbstractCodeBaseEntity> implements InitializingBean {
    ...
    protected Class<T> getDomainClass() {
        return (Class<T>) TypeUtils.getTypeArguments(getClass(), AbstractCodeBaseRepositoryImpl.class)
                .values()
                .iterator().next();
    }
